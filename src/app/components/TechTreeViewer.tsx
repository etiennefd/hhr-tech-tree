  ...
  return (
    <div className="fixed inset-0 flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
        <div style={{ 
            width: Math.max((MAX_YEAR - MIN_YEAR) * YEAR_WIDTH + PADDING * 2, parseFloat('100%')),
            ...
            >
              ...
              {/* Hover tooltip */}
                ...
                <div className="absolute z-10 bg-white border rounded-lg p-3 shadow-lg -bottom-24 left-1/2 transform -translate-x-1/2 w-64">
                    <p className="text-xs mb-1"><strong>Date:</strong> {formatYear(node.year)}</p>
                    {node.description && (
...
export const TechTreeViewerNoSSR = dynamic(() => Promise.resolve(TechTreeViewer), {
  ssr: false
});